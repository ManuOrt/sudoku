...
def checkSudoku(sudoku):
    ...
    from FP_Superior_dual.David_Python.sudoku.src.checkCuadrado import checkCuadrado
    from FP_Superior_dual.David_Python.sudoku.src.checkNumerosEnRango import checkNumerosEnRango
    from FP_Superior_dual.David_Python.sudoku.src.checkFilas import checkFilas
    from FP_Superior_dual.David_Python.sudoku.src.checkColumnas import checkColumnas
